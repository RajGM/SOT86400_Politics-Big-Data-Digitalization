 ...
 * Tracks progress in youtube_raw/master_state.json. Fully resumable.
 *
 * Usage:
 *   node masterYouTube.js [--startDate 2020-01-01] [--endDate 2026-07-13] [--outDir ./youtube_raw] [--channel uk_parliament] [--concurrency 1]
 *
 * Environment:
 *   YOUTUBE_API_KEY — YouTube Data API v3 key (recommended)
 *                     Without it, scrapeYouTube falls back to yt-dlp for listing.
 *
 * Setup:
 *   npm install
...
async function main() {
  ...
  if (!process.env.YOUTUBE_API_KEY) {
    console.log("Note: YOUTUBE_API_KEY not set — channel listing will use yt-dlp fallback.\n");
  }
